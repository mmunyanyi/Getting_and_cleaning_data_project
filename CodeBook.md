...
In the Tidy_Data_Set.txt file of this repository is the data set.

The README.md file of this repository contains background information on the data set.
...
The zip file containing the source data can be found on https://d396qusza40orc.cloudfront.net/getdata%2Fprojectfiles%2FUCI%20HAR%20Dataset.zip.
